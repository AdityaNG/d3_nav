...
def main():
    ...
    for idx in range(len(dataset)):
        ...
        cv2.putText(combined_cam, "Original", (10, 30), font, 1, (255, 255, 255), 2)
        cv2.putText(combined_cam, "Reconstructed", (10, combined_cam.shape[0]//2 + 30), font, 1, (255, 255, 255), 2)
        cv2.putText(combined_bev, "Original", (10, 30), font, 1, (255, 255, 255), 2)
        cv2.putText(combined_bev, "Reconstructed", (10, combined_bev.shape[0]//2 + 30), font, 1, (255, 255, 255), 2)
